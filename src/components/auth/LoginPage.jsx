...
import { useLoginUser } from '../../hooks/useLoginUser'; // Adjust the path if needed
        ...
        <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-lg m-4">
          <div className="text-center mb-8">
            <a href="#" onClick={() => navigate('home')}>
              <img src="/hamro2.png" className="h-12 w-auto mx-auto" alt="logo" />
            </a>
...
// Note: Ensure that the `useLoginUser` hook is correctly implemented in your hooks file.
// This component handles user login, integrates with the custom hook for login mutation,
...
//           <div>
//             <h3 className="text-2xl font-bold mb-4">HamroGrocery</h3>
//             <p className="text-gray-400 text-sm">Your daily dose of freshness, delivered right to your door.</p>
//           </div>
...
//             <p className="text-grey-400 mb-4 text-sm">Subscribe for updates and offers.</p>

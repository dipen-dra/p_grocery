...
//     const products = [
//         { id: 1, name: 'Himalayan Apples', price: 'Rs. 250 / kg', image: 'https://placehold.co/400x400/fecaca/dc2626?text=Apples' },
//         { id: 2, name: 'Organic Spinach', price: 'Rs. 80 / bunch', image: 'https://placehold.co/400x400/dcfce7/16a34a?text=Spinach' },
//         { id: 3, name: 'Artisan Sourdough', price: 'Rs. 220 / loaf', image: 'https://placehold.co/400x400/fed7aa/f97316?text=Bread' },
//         { id: 4, name: 'Fresh Cow Milk', price: 'Rs. 90 / liter', image: 'https://placehold.co/400x400/dbeafe/3b82f6?text=Milk' },
//     ];
...
//                         <div key={product.id} className="bg-white rounded-lg shadow-md overflow-hidden group transform transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
